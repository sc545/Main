...
public class MainStage6 extends Activity {
...
// static max10, 0key5,uket5 현재 방갯수는 서버에서관리하기
    ...
    Setting setting;
    public static MainStage6 mainStage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_stage6);
        mainStage = this;


        
        btnSet = (Button)findViewById(R.id.btnMainStageSet6);
